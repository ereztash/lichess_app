...
| repo SHA | `4dd4842eed7c67f8a555167e4ee272876ae81eb0` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_gilrivera_COHORT` |
...
- DERIVE 9040 decisions / 266 games
- VALIDATE 2807 / 89
- TEST 2712 / 89 (opened once, for the frozen candidate only)

## BROAD STRUCTURE (R*)

    own_overloaded_piece_count>=1

| frozen on DERIVE | n 2270 | rate in/out 23.4% / 10.8% | within-game +12.4 pp (z 10.69) |
| judged on VALIDATE | n_in 736 | rate in/out 26.4% / 11.4% | within-game +14.2 pp (z 7.13), residual z 4.62 |
| stability | 100.0% of 30 game-level bootstrap winners share Jaccard >= 0.60 with it (median J 1.00) |

## HOLDOUT RESULT (TEST)

- region on TEST: n_in 688, rate in/out 23.0% / 10.7% (z 6.16)
- held-out log-loss / AUC: baseline 0.3731 / 0.702 → baseline + region 0.3697 / 0.712
- within-game label-shuffle p for the region's gain: 0.000 (200 draws)

## POPULATION COMPARISON

- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1657.0)
...
- this player sits at the 68th percentile of that distribution
