# Replication report — lichess/chessterr1883
...
| repo SHA | `abf3fbcfa710b932f600e6a60c0d5d3a7f5571ef` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_chessterr1883_COHORT` |

## PLAYER

- platform: lichess
- username: chessterr1883 (canonical id `chessterr1883`)
- corpus label: `lichess:chessterr1883`
...
- eligible decisions: 13119
- speeds: {'blitz': 415, 'bullet': 35}
...
- DERIVE 7814 decisions / 270 games
- VALIDATE 2856 / 90
- TEST 2449 / 90 (opened once, for the frozen candidate only)
