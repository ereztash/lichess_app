# Replication report — lichess/sajahggggtggggggg
...
| repo SHA | `a938744f6f7c2c233fe23c0177c19c3a143eb6da` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_sajahggggtggggggg_COHORT` |

## PLAYER

- platform: lichess
- username: sajahggggtggggggg (canonical id `sajahggggtggggggg`)
- corpus label: `lichess:sajahggggtggggggg`
...
- eligible decisions: 15918
- speeds: {'blitz': 323, 'bullet': 127}
...
- DERIVE 9323 decisions / 270 games
- VALIDATE 3104 / 90
- TEST 3491 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1633.0)
