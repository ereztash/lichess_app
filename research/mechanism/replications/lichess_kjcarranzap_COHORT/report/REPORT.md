# Replication report — lichess/kjcarranzap
...
| repo SHA | `83c9c027ba3726b544e7c2c9bab6e2033583eef9` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_kjcarranzap_COHORT` |

## PLAYER

- platform: lichess
- username: kjcarranzap (canonical id `kjcarranzap`)
- corpus label: `lichess:kjcarranzap`
...
- DERIVE 8536 decisions / 270 games
- VALIDATE 3014 / 90
- TEST 2620 / 90 (opened once, for the frozen candidate only)
