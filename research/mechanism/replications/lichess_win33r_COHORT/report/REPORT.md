# Replication report — lichess/win33r
...
| repo SHA | `13e6892580a3c419ac6ee40fe2d673b7ee32a144` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_win33r_COHORT` |

## PLAYER

- platform: lichess
- username: win33r (canonical id `win33r`)
- corpus label: `lichess:win33r`
...
- eligible decisions: 13070
- speeds: {'blitz': 32, 'bullet': 418}
...
- DERIVE 7743 decisions / 270 games
- VALIDATE 2609 / 90
- TEST 2718 / 90 (opened once, for the frozen candidate only)
