...
| repo SHA | `36c7ead82c2fead5659844c1d62e7ede1e8d0baa` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_christianjessen_COHORT` |

## PLAYER

- platform: lichess
- username: christianjessen (canonical id `christianjessen`)
- corpus label: `lichess:christianjessen`
...
- eligible decisions: 11090
- speeds: {'blitz': 411, 'classical': 2, 'rapid': 37}
...
- DERIVE 6585 decisions / 270 games
- VALIDATE 2300 / 90
- TEST 2205 / 90 (opened once, for the frozen candidate only)
