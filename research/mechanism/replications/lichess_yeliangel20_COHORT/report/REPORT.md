# Replication report — lichess/yeliangel20
...
| run directory | `/home/user/lichess_app/research/mechanism/replications/lichess_yeliangel20_COHORT` |

## PLAYER

- platform: lichess
- username: yeliangel20 (canonical id `yeliangel20`)
- corpus label: `lichess:yeliangel20`
...
- DERIVE 8758 decisions / 270 games
- VALIDATE 3038 / 90
- TEST 2993 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1636.0)
