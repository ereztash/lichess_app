# Replication report — lichess/vivasandino
...
| repo SHA | `d269acc4ba15025118b236db1675ed5c07bee679` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_vivasandino_COHORT` |

## PLAYER

- platform: lichess
- username: vivasandino (canonical id `vivasandino`)
- corpus label: `lichess:vivasandino`
...
- DERIVE 6259 decisions / 270 games
- VALIDATE 2024 / 90
- TEST 2252 / 90 (opened once, for the frozen candidate only)
