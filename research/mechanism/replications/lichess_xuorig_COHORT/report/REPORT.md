# Replication report — lichess/xuorig
...
| repo SHA | `4c2cb6cc1b3d86990d337e06c05d27a8b942404f` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_xuorig_COHORT` |

## PLAYER

- platform: lichess
- username: xuorig (canonical id `xuorig`)
- corpus label: `lichess:xuorig`
...
- eligible decisions: 57850
- speeds: {'blitz': 2193, 'bullet': 7}
...
- DERIVE 34658 decisions / 1320 games
- VALIDATE 11798 / 440
- TEST 11394 / 440 (opened once, for the frozen candidate only)

## BROAD STRUCTURE (R*)

    material_balance>=-2 AND own_overloaded_piece_count>=1

| frozen on DERIVE | n 8807 | rate in/out 25.3% / 13.6% | within-game +11.9 pp (z 21.77) |
| judged on VALIDATE | n_in 3023 | rate in/out 24.3% / 13.5% | within-game +11.0 pp (z 11.49), residual z 6.68 |
| stability | 90.0% of 30 game-level bootstrap winners share Jaccard >= 0.60 with it (median J 1.00) |

## HOLDOUT RESULT (TEST)

- region on TEST: n_in 2897, rate in/out 24.6% / 13.5% (z 11.20)
- held-out log-loss / AUC: baseline 0.4142 / 0.693 → baseline + region 0.4110 / 0.703
...
| frozen on DERIVE | n 6856 | rate in/out 19.3% / 15.8% | within-game +5.5 pp (z 6.73) |
| judged on VALIDATE | n_in 2325 | rate in/out 19.7% / 15.4% | within-game +7.0 pp (z 5.35), residual z 4.83 |
