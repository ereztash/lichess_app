# Replication report — lichess/yurisato123
...
| repo SHA | `eb63847b23fce61171f022155273d21d5d76b610` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_yurisato123_COHORT` |

## PLAYER

- platform: lichess
- username: yurisato123 (canonical id `yurisato123`)
- corpus label: `lichess:yurisato123`
...
- eligible decisions: 13940
- speeds: {'blitz': 377, 'bullet': 63, 'rapid': 10}
...
- DERIVE 7973 decisions / 270 games
- VALIDATE 2985 / 90
- TEST 2982 / 90 (opened once, for the frozen candidate only)
