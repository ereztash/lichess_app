# Replication report — lichess/wildhorse420
...
| repo SHA | `05defd764c581478ce9aa82dc29f8a43d9727d8d` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_wildhorse420_COHORT` |

## PLAYER

- platform: lichess
- username: wildhorse420 (canonical id `wildhorse420`)
- corpus label: `lichess:wildhorse420`
...
- DERIVE 7285 decisions / 270 games
- VALIDATE 2444 / 90
- TEST 2549 / 90 (opened once, for the frozen candidate only)
