# Replication report — lichess/josephm613
...
| repo SHA | `37484fe450e402425847eb37d9ca705d59dc1424` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_josephm613_COHORT` |

## PLAYER

- platform: lichess
- username: josephm613 (canonical id `josephm613`)
- corpus label: `lichess:josephm613`
...
- `outside-window`: 238
- `termination:Abandoned`: 6
- `termination:Time forfeit`: 236
- `under-20-plies`: 20
...
- DERIVE 8837 decisions / 270 games
- VALIDATE 3007 / 90
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1630.0)
