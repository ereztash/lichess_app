# Replication report — lichess/dm77777
...
| repo SHA | `fb91cbd663a40fb547a197f4aa48ce089906b5d1` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_dm77777_COHORT` |

## PLAYER

- platform: lichess
- username: dm77777 (canonical id `dm77777`)
- corpus label: `lichess:dm77777`
...
- eligible decisions: 15819
- speeds: {'blitz': 367, 'bullet': 66, 'rapid': 13, 'ultraBullet': 4}
...
- DERIVE 9026 decisions / 270 games
- VALIDATE 3402 / 90
- TEST 3391 / 90 (opened once, for the frozen candidate only)
