# Replication report — lichess/lichisss
...
| repo SHA | `caca399954aa0e35354dd26a893f0f6a712c9e07` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_lichisss_COHORT` |

## PLAYER

- platform: lichess
- username: lichisss (canonical id `lichisss`)
- corpus label: `lichess:lichisss`
...
- eligible decisions: 11397
- speeds: {'blitz': 292, 'bullet': 157, 'rapid': 1}
...
- DERIVE 6777 decisions / 270 games
- VALIDATE 2271 / 90
- TEST 2349 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1646.5)
