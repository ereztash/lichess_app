# Replication report — lichess/ilpiccolopico
...
| repo SHA | `83d6b046bc3464cecb44d6f3f08b8c3624dad6ab` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_ilpiccolopico_COHORT` |

## PLAYER

- platform: lichess
- username: ilpiccolopico (canonical id `ilpiccolopico`)
- corpus label: `lichess:ilpiccolopico`
...
- eligible decisions: 11599
- speeds: {'blitz': 448, 'bullet': 1, 'rapid': 1}
...
- DERIVE 6687 decisions / 270 games
- VALIDATE 2362 / 90
- TEST 2550 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1631.5)
