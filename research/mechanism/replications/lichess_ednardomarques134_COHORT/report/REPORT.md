# Replication report — lichess/ednardomarques134
...
| repo SHA | `f2a9611469a3c849f423f61335d71c2b12fbdfc3` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_ednardomarques134_COHORT` |

## PLAYER

- platform: lichess
- username: ednardomarques134 (canonical id `ednardomarques134`)
- corpus label: `lichess:ednardomarques134`
...
- `outside-window`: 210
- `termination:Abandoned`: 5
- `termination:Insufficient material`: 1
- `termination:Time forfeit`: 272
- `under-20-plies`: 12
...
- DERIVE 9220 decisions / 270 games
- VALIDATE 3098 / 90
