# Replication report — lichess/m-glamas
...
| repo SHA | `2e7fad90d4f47b809d050a076401124c51106aa4` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_m-glamas_COHORT` |

## PLAYER

- platform: lichess
- username: m-glamas (canonical id `m-glamas`)
- corpus label: `lichess:m-glamas`
...
- DERIVE 7122 decisions / 270 games
- VALIDATE 2281 / 90
- TEST 2279 / 90 (opened once, for the frozen candidate only)
