# Replication report — lichess/pumuckel
...
| repo SHA | `f782ffc6da1e08cb238490b8c5dab997d39e2ba6` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_pumuckel_COHORT` |

## PLAYER

- platform: lichess
- username: pumuckel (canonical id `pumuckel`)
- corpus label: `lichess:pumuckel`
...
- `outside-window`: 347
- `termination:Insufficient material`: 4
- `termination:Time forfeit`: 89
- `under-20-plies`: 60
...
- DERIVE 6907 decisions / 270 games
- VALIDATE 2265 / 90
- TEST 2223 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1668.5)
