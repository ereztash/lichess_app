...
| repo SHA | `e7ae239016b8d55ce62c53a0fe547bb19d167844` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_grebmesorchess_COHORT` |
...
- DERIVE 6394 decisions / 270 games
- VALIDATE 2036 / 90
- TEST 2118 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1667.5)
