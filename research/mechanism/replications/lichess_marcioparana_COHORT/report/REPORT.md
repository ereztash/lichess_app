# Replication report — lichess/marcioparana
...
| repo SHA | `d6e893fe4f049a0e32dc8a4b056f773c06e964e5` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_marcioparana_COHORT` |

## PLAYER

- platform: lichess
- username: marcioparana (canonical id `marcioparana`)
- corpus label: `lichess:marcioparana`
...
- DERIVE 9057 decisions / 270 games
- VALIDATE 3254 / 90
- TEST 3336 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1662.0)
