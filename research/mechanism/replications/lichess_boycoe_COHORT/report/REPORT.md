# Replication report — lichess/boycoe
...
| repo SHA | `dfd628f371980816fc8bd3dba7158d727b3b6651` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_boycoe_COHORT` |

## PLAYER

- platform: lichess
- username: boycoe (canonical id `boycoe`)
- corpus label: `lichess:boycoe`
...
- eligible decisions: 12887
- speeds: {'blitz': 431, 'bullet': 19}
...
- DERIVE 7800 decisions / 270 games
- VALIDATE 2532 / 90
- TEST 2555 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1669.0)
