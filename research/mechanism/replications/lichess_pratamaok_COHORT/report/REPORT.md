# Replication report — lichess/pratamaok
...
| repo SHA | `a8b94dbc85984e14920e53ccf056ab121a795b84` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_pratamaok_COHORT` |

## PLAYER

- platform: lichess
- username: pratamaok (canonical id `pratamaok`)
- corpus label: `lichess:pratamaok`
...
- DERIVE 8824 decisions / 270 games
- VALIDATE 2794 / 90
- TEST 3052 / 90 (opened once, for the frozen candidate only)
