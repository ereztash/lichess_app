# Replication report — lichess/jskeens
...
| repo SHA | `4a67a35fe6c8bf690b720c02de15af53a723b787` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_jskeens_COHORT` |

## PLAYER

- platform: lichess
- username: jskeens (canonical id `jskeens`)
- corpus label: `lichess:jskeens`
...
- DERIVE 8158 decisions / 270 games
- VALIDATE 2865 / 90
- TEST 2852 / 90 (opened once, for the frozen candidate only)
