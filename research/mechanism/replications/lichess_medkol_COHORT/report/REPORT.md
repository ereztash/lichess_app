# Replication report — lichess/medkol
...
| run directory | `/home/user/lichess_app/research/mechanism/replications/lichess_medkol_COHORT` |

## PLAYER

- platform: lichess
- username: medkol (canonical id `medkol`)
- corpus label: `lichess:medkol`
...
- DERIVE 8997 decisions / 270 games
- VALIDATE 3029 / 90
- TEST 2901 / 90 (opened once, for the frozen candidate only)
