...
| repo SHA | `48688e212e2c4f62c56cf7d36670ca0b5539c4be` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_sgad_COHORT` |

## PLAYER

- platform: lichess
- username: sgad (canonical id `sgad`)
- corpus label: `lichess:sgad`
...
- eligible decisions: 12295
- speeds: {'blitz': 400, 'bullet': 50}
...
- DERIVE 7549 decisions / 270 games
- VALIDATE 2306 / 90
- TEST 2440 / 90 (opened once, for the frozen candidate only)
