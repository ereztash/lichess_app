# Replication report — lichess/akkaclaros
...
| repo SHA | `ece646713d3bef5a6ddcf0fbfc8feea4503f4969` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_akkaclaros_COHORT` |

## PLAYER

- platform: lichess
- username: akkaclaros (canonical id `akkaclaros`)
- corpus label: `lichess:akkaclaros`
...
- DERIVE 6569 decisions / 270 games
- VALIDATE 2665 / 90
- TEST 2438 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1653.5)
