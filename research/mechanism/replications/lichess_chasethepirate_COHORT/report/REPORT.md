# Replication report — lichess/chasethepirate
...
| repo SHA | `0ffc8b51c66b0bdeaa37b910d5b41e09f50b1c93` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_chasethepirate_COHORT` |

## PLAYER

- platform: lichess
- username: chasethepirate (canonical id `chasethepirate`)
- corpus label: `lichess:chasethepirate`
...
- eligible decisions: 14247
- speeds: {'blitz': 443, 'rapid': 7}
...
- DERIVE 8514 decisions / 270 games
- VALIDATE 2787 / 90
- TEST 2946 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1639.0)
