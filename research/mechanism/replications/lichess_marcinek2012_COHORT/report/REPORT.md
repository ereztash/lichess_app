# Replication report — lichess/marcinek2012
...
| repo SHA | `47cd47be34842ed2ddc8b6b7d8152c42333828ce` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_marcinek2012_COHORT` |

## PLAYER

- platform: lichess
- username: marcinek2012 (canonical id `marcinek2012`)
- corpus label: `lichess:marcinek2012`
...
- DERIVE 8229 decisions / 270 games
- VALIDATE 2706 / 90
- TEST 2476 / 90 (opened once, for the frozen candidate only)
