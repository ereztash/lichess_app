# Replication report — lichess/nerdstomper3
...
| repo SHA | `7eda430b649d04f213490c526724f3bafdde3794` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_nerdstomper3_COHORT` |

## PLAYER

- platform: lichess
- username: nerdstomper3 (canonical id `nerdstomper3`)
- corpus label: `lichess:nerdstomper3`
...
- DERIVE 6724 decisions / 270 games
- VALIDATE 2074 / 90
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1670.0)
