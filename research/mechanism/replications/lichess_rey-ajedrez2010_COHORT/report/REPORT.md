# Replication report — lichess/rey-ajedrez2010
...
| repo SHA | `0d397f98781466ec5763e51b50a6191b1c253ae7` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_rey-ajedrez2010_COHORT` |

## PLAYER

- platform: lichess
- username: rey-ajedrez2010 (canonical id `rey-ajedrez2010`)
- corpus label: `lichess:rey-ajedrez2010`
...
- DERIVE 7334 decisions / 270 games
- VALIDATE 2415 / 90
- TEST 2361 / 90 (opened once, for the frozen candidate only)
...
- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1669.5)
