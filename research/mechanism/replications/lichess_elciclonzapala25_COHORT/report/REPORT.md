# Replication report — lichess/elciclonzapala25
...
| repo SHA | `26bc09b853adcb54a43b2aa755b594f7283ae814` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_elciclonzapala25_COHORT` |

## PLAYER

- platform: lichess
- username: elciclonzapala25 (canonical id `elciclonzapala25`)
- corpus label: `lichess:elciclonzapala25`
...
- eligible decisions: 13731
- speeds: {'blitz': 402, 'bullet': 5, 'classical': 1, 'rapid': 42}
...
- `no-clocks`: 10
- `outside-window`: 161
- `termination:Abandoned`: 18
- `termination:Time forfeit`: 300
- `under-20-plies`: 11
...
- DERIVE 8494 decisions / 270 games
- VALIDATE 2603 / 90
- TEST 2634 / 90 (opened once, for the frozen candidate only)

## BROAD STRUCTURE (R*)

    own_overloaded_piece_count>=1

| frozen on DERIVE | n 2372 | rate in/out 21.9% / 10.5% | within-game +11.2 pp (z 11.28) |
| judged on VALIDATE | n_in 777 | rate in/out 21.6% / 10.6% | within-game +11.2 pp (z 6.26), residual z 3.65 |
| stability | 96.7% of 30 game-level bootstrap winners share Jaccard >= 0.60 with it (median J 1.00) |

## HOLDOUT RESULT (TEST)

- region on TEST: n_in 783, rate in/out 22.7% / 9.5% (z 7.79)
- held-out log-loss / AUC: baseline 0.3652 / 0.703 → baseline + region 0.3599 / 0.719
- within-game label-shuffle p for the region's gain: 0.000 (200 draws)

## POPULATION COMPARISON

- band derived from the focal player's own blitz median rating: [1450, 1850] (median 1665.0)
