# Replication report — lichess/sumanbala
...
| repo SHA | `df942bab26b35a2e33a5eff93e245903b491c8be` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_sumanbala_COHORT` |

## PLAYER

- platform: lichess
- username: sumanbala (canonical id `sumanbala`)
- corpus label: `lichess:sumanbala`
...
- DERIVE 8979 decisions / 270 games
- VALIDATE 3056 / 90
