# Replication report — lichess/omar2137
...
| repo SHA | `6e86c21bdddc9c68c532773e64af70f47d018dfb` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_omar2137_COHORT` |

## PLAYER

- platform: lichess
- username: omar2137 (canonical id `omar2137`)
- corpus label: `lichess:omar2137`
...
- DERIVE 9434 decisions / 270 games
- VALIDATE 3004 / 90
- TEST 3238 / 90 (opened once, for the frozen candidate only)
