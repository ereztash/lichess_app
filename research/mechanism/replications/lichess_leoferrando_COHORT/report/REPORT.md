# Replication report — lichess/leoferrando
...
| repo SHA | `fb96e4e96fd801262d9b64232d542c59bc4ee02e` |
| pipeline hash | `eb840a439af4439bd44ed5a8da5ca76569fb8c68d38c34a6ba19eb2961da3143` |
| run directory | `/work/research/mechanism/replications/lichess_leoferrando_COHORT` |

## PLAYER

- platform: lichess
- username: leoferrando (canonical id `leoferrando`)
- corpus label: `lichess:leoferrando`
...
- DERIVE 7387 decisions / 270 games
- VALIDATE 2493 / 90
- TEST 2399 / 90 (opened once, for the frozen candidate only)

## BROAD STRUCTURE (R*)

    own_overloaded_piece_count>=1

| frozen on DERIVE | n 2886 | rate in/out 23.5% / 13.8% | within-game +9.6 pp (z 9.60) |
| judged on VALIDATE | n_in 994 | rate in/out 24.2% / 12.4% | within-game +11.9 pp (z 7.85), residual z 5.04 |
| stability | 86.7% of 30 game-level bootstrap winners share Jaccard >= 0.60 with it (median J 0.83) |

## HOLDOUT RESULT (TEST)

- region on TEST: n_in 965, rate in/out 23.3% / 13.3% (z 5.53)
- held-out log-loss / AUC: baseline 0.4431 / 0.641 → baseline + region 0.4387 / 0.658
