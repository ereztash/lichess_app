      ...
      <main className="boundary" dir="rtl">
        <div className="boundary-card">
          ...
          <p className="boundary-body">
            {staleBuild
              ? "יצאה גרסה חדשה בזמן שהעמוד הזה היה פתוח, וחלק מהקבצים שהוא ביקש כבר לא קיימים בשם הזה. טעינה מחדש פותרת את זה. החלטות שכבר נרשמו נשמרו — ההיסטוריה נכתבת בכל החלטה, לא בסוף המשחק."
              : "זו תקלה באפליקציה ולא במשהו שעשיתם. החלטות שכבר נרשמו נשמרו — ההיסטוריה נכתבת בכל החלטה, לא בסוף המשחק."}
          </p>
          <button
            type="button"
