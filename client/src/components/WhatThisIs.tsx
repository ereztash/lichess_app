  ...
  return (
    <section className="what-this-is" aria-label="מה זה המקום הזה">
      ...
      <p>
        ...
        מה שקרה בפועל</strong>. בשחמט קוראים לזה כיול.
      </p>
      ...
      <p>
        דפוס אחד דורש {MIN_BUCKET_N * 2} החלטות חשופות, ואם ייבאת משחקים ונמצא בהם דלי אחד שנבדל
      ...
      <h4>מה נשאר אצלך</h4>
      <p>
        בלי התחברות, ההחלטות נשמרות בדפדפן הזה בלבד והמידע לא עוזב את המחשב. המנוע רץ מקומית. אם
        הדפדפן חוסם אחסון קבוע, המסך יאמר את זה — ולא יעמיד פנים שנשמר.
      </p>
