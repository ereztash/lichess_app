...
עשרים ושניים שערים, כל אחד נשלח עם בקרה חיובית שחייבת להיות מודגמת **אדומה**. שער שמעולם לא נכשל
...
| GATE-ONE-PRIMARY-ACTION | LAW 2 | דלת כניסה שמציעה שני מוצרים, וחשיפה שמציעה את אותה פעולה פעמיים |
| GATE-TOOLBOX-OUTSIDE-FOCUS | LAW 2 | ארגז הכלים נטען לכל נכנס ונפתח בלי שאיש לחץ עליו |

שבעת האחרונים הם **החוקים האינרציאליים** ([`docs/INERTIAL_UX_LAWS.md`](docs/INERTIAL_UX_LAWS.md)),
והם טענה מסוג אחר מהחמישה-עשר שמעליהם: אלה קוראים קוד כדי לבדוק טענה על **מדידה**, ואלה קוראים קוד
כדי לבדוק טענה על **מצב** — איזה משטחים מותר שיהיו על המסך בזמן שהשחקן נמצא באחד מהם. מתחת לזה זה
אותו דבר: ביטחון שנמסר מול פאנל שמתאר את הכיול של אותו שחקן אינו מדידה של מה שהוא האמין.
