...
| [`docs/neta/NETA_EMBODIED_RUN_001.md`](docs/neta/NETA_EMBODIED_RUN_001.md) | המוצר נמדד כחוויה, לא כקוד: הרצה של `Product-Perception-Sensemaking-Architect` מול הדיפלוי החי. אותות גולמיים לפני פרשנות, שישה ממצאים מול הסכימה שלו, ושלושה ממצאים שכמעט נכתבו ונהרגו על ידי דיסקרימינטור | אנגלית, אותות בעברית |
