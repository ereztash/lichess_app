...
עשרים שערים, כל אחד נשלח עם בקרה חיובית שחייבת להיות מודגמת **אדומה**. שער שמעולם לא נכשל
...
חמשת האחרונים הם **החוקים האינרציאליים** ([`docs/INERTIAL_UX_LAWS.md`](docs/INERTIAL_UX_LAWS.md)),
