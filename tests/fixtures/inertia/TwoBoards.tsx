 ...
 *
 * ITS BOARDS DECLARE `authority="none" sideToMove="w"`, which is the one constant `GATE-BOARD-AUTHORITY` allows,
...
export function TwoBoards() {
  return (
    <div>
      <ChessBoard board={[]} orientation="w" authority="none" sideToMove="w" legalTargets={[]} onSelect={() => undefined} onMove={() => undefined} />
