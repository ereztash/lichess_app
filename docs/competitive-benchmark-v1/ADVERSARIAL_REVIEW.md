...
## Ways the draft favored Decision Lab

| Weakness | Mechanism | Repair | Decision value |
|---|---|---|---|
| 1–5 scores | researcher taste masquerades as measurement | delete scores; binary capability + observed outcomes | high: removes predetermined winner |
...
| single-product incumbents | DL gets chain, rivals get fragments | qualify Chess.com/Aimchess and allow fixed BAA workflow | high |
| rubric rewards bounded claims | may mirror DL's epistemics | ground truth and overclaim scored separately; objective primary | medium |

## Ways the draft favored incumbents
...
| outage/bug called invalid | protects immature product or can punish it arbitrarily | product failures count; research failures invalidate | critical |
| one language/market | may hide DL's target advantage or burden | define Hebrew target; report language mechanism | medium |
| BAA winner selected and tested on same people | winner's curse | fresh qualification vs confirmatory samples | high |
...
- Participants cannot be blinded to UI.
- Native workflows cannot have identical inputs without destroying ecological validity.
- 72h transfer is not long-term improvement.
- BAA bundle may be less coherent than a single product.
- Human coaching remains outside v1.
- Product changes after the freeze limit external validity.

These do not disappear in analysis; they bound the claim.
