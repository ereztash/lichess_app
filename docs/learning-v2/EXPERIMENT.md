...
3. sensitivity and criterion only where their assumptions are appropriate;
...
A headline improvement that raises both hits and false alarms is a criterion/bias shift until shown
otherwise.
