...
- **No reference class exists for the confidence half.** No published distribution of stated-
  ...
  to. The population baseline in section 4c does **not** close this: it is an accuracy baseline
  built from games in which nobody was ever asked how sure they were, so it makes a bucket's
  accuracy interpretable and leaves the gap, the reliability term and AUROC2 as un-referenced as
  they were.
