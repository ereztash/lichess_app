...
const lines = [
  ...
  "  deployment suite        NOT RUN here -- 11 tests need a deployed origin and run in deployed.yml,",
  "                          two of them the FIELD stimulus freeze against the origin a participant opens",
